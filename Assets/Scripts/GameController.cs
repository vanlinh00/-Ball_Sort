...
public class GameController : MonoBehaviour
{
    ...
    public void createLevel(int totalBall)
    {
        ...
        for (int i = 0; i < totalBall; i++)
        {
            ...
            createTube.transform.parent = _setUpGame.transform;
                    ...
                    if (countBallTube2 != 0)
                    {
                        ...
                        if (countBallInTubeMove == 0)
                        {
                            ...
                            if (allTube[psTubleMove].GetComponent<Tube>().checkAllSameBall())
                            {
                                ...
                                GameObject _newParticle = Instantiate(Resources.Load("WinEffect", typeof(GameObject))) as GameObject;
                                _newParticle.transform.position = allTube[psTubleMove].transform.position;
    ...
    public async void tubleFulllSameColorAudio()
    {
        ...
        checkDonelevel++;
        if (checkDonelevel == ranDomTube - 2)
        {
            await Task.Delay(1000);
